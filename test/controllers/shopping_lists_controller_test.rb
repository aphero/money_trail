...
class ShoppingListsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shopping_list" do
    assert_difference('ShoppingList.count') do
      post shopping_lists_url, params: { shopping_list: { store_id: @shopping_list.store_id, total: @shopping_list.total, user_id: @shopping_list.user_id } }
    end
  ...
  test "should update shopping_list" do
    patch shopping_list_url(@shopping_list), params: { shopping_list: { store_id: @shopping_list.store_id, total: @shopping_list.total, user_id: @shopping_list.user_id } }
