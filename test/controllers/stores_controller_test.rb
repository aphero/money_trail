...
class StoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create store" do
    assert_difference('Store.count') do
      post stores_url, params: { store: { location_id: @store.location_id, name: @store.name } }
    end
  ...
  test "should update store" do
    patch store_url(@store), params: { store: { location_id: @store.location_id, name: @store.name } }
